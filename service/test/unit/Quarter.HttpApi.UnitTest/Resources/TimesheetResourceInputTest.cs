...
public class TimesheetResourceInputTest
{
    ...
    public class WhenConstructingConstructingFromValidInput
    {
        public static IEnumerable<object[]> ValidResources()
        {
            yield return
            [
                new TimesheetResourceInput { date = "2023-01-28", timeSlots =
                [
                    new TimeSlotInput
            {
    ...
    public class WhenConstructingConstructingFromInvalidInput
    {
        ...
        {
            yield return [new TimesheetResourceInput { date = null }, "The date field is required."];
            yield return [new TimesheetResourceInput { date = "" }, "The date field is required."];
            yield return [new TimesheetResourceInput { date = "28-01-23" }, "The date must be given in ISO-8601 (YYYY-MM-DD).",
            ];
            yield return [new TimesheetResourceInput { timeSlots = null }, "The timeSlots field is required."];
            yield return [new TimesheetResourceInput { timeSlots = [] }, "The timeSlots field must not be empty.",
            ];
            yield return
            [
                new TimesheetResourceInput { date = "2023-01-28", timeSlots =
