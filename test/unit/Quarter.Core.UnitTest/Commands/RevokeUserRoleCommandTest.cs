...
{
    public abstract class RevokeRoleCommandTest : CommandTestBase<RevokedUserRoleEvent>
    {
        ...
        public class WhenUserExist : RevokeRoleCommandTest
        {
            ...
            [Test]
            public void ItShouldDispatchRevokedUserRoleEvent()
            {
                var (userId, userRoles) = EventSubscriber.CollectedEvents.Single();
